...
namespace wfaEmployeeProject.NorthwindContext
{
    public partial class NorthwindContext1 : DbContext
    {
        public NorthwindContext1()
        {
        }

        public NorthwindContext1(DbContextOptions<NorthwindContext1> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Employees2> Employees2s { get; set; } = null!;
        ...
        public virtual DbSet<ViewCustomerTotal> ViewCustomerTotals { get; set; } = null!;
        public virtual DbSet<ViewEmployeeManager> ViewEmployeeManagers { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-7G5LBG3\\SQLSERVERBG;User ID=sa;Password=unequalled88;Database=Northwind;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ViewCustomerTotal>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("View_CustomerTotal");
                ...
                entity.Property(e => e.CustomerTotal).HasColumnName("Customer Total");
            });

            modelBuilder.Entity<ViewEmployeeManager>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("View_EmployeeManager");
